...
\begin{figure}[!h]
    \begin{minipage}{.5\textwidth} 
        \centering 
        \includegraphics[width=.4\linewidth]{logo-debian.png} 
        \caption{Logo Debian} 
        \label{fig:virtualbox} 
    \end{minipage}% 
    \begin{minipage}{.5\textwidth} 
        \centering 
        \includegraphics[width=.4\linewidth]{logo-centos.png} 
        \caption{Logo CentOS} 
        \label{fig:pycharm} 
    \end{minipage}  
\end{figure}
...
\begin{figure}[!h]
    \begin{minipage}{.5\textwidth} 
        \centering 
        \includegraphics[width=.6\linewidth]{logo-redis.png} 
        \caption{Redis} 
        \label{fig:redis} 
    \end{minipage}% 
    \begin{minipage}{.5\textwidth} 
        \centering 
        \includegraphics[width=.3\linewidth]{logo-celery.png} 
        \caption{Logo Celery} 
        \label{fig:celery} 
    \end{minipage}% 
\end{figure}
...
\textit{Amazon S3} (Simple Storage Service) è un servizio web di memorizzazione offerto da Amazon Web Services ed è stato utilizzato per immagazzinare gli screenshot e il codice sorgente delle pagine classificate interessanti dal modulo mentre \textit{Elasticsearch} è un server di ricerca basato su Lucene, con capacità Full Text, con supporto ad architetture distribuite. Tutte le funzionalità sono nativamente esposte tramite interfaccia RESTful ed è stato utilizzato per immagazzinare e ricercare le pagine interessanti per il modulo insieme a tutti i metadati correlati alla ricerca.
\begin{figure}[!h]
    \begin{minipage}{.5\textwidth} 
        \centering 
        \includegraphics[width=.5\linewidth]{logo-amazons3.png} 
        \caption{Amazon S3} 
        \label{fig:amazons3} 
    \end{minipage}% 
    \begin{minipage}{.5\textwidth} 
        \centering 
        \includegraphics[width=.5\linewidth]{logo-elasticsearch.png} 
...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.4\columnwidth]{logo-selenium.png} 
