...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.4\columnwidth]{chapter4-project/test_con_memory_leak.png} 
...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.4\columnwidth]{chapter4-project/test_senza_memory_leak.png} 
